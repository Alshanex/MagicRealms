package net.alshanex.magic_realms.entity.humans.exclusive.alshanex;
...
public class AlshanexEntity extends AbstractMercenaryEntity implements IExclusiveMercenary, IChatFaceProvider {
    ...
    private static final ResourceLocation NO_ONE =
            ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "of_no_consequence");
        ...
        if (!this.level().isClientSide) {
            ...
            this.level().getServer().execute(() -> {
                if (this.isAlive() && !this.isRemoved()) {
                    TitleManager.grantSilently(this, List.of(NO_ONE));
                    TitleManager.setDisplayedTitle(this, NO_ONE);
