...
public class TextureComponents {
    ...
    public static TextureComponents fromMetadata(CompoundTag metadata) {
        if (metadata.getBoolean("usePreset")) {
            return new TextureComponents(
                    metadata.getString("presetTexture"), null, null, null,
                    metadata.contains("presetName") ? metadata.getString("presetName") : null,
                    true);
        }
        return new TextureComponents(
