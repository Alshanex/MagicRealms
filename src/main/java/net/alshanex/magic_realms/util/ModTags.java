...
public class ModTags {
    ...
    public static final TagKey<EntityType<?>> GOJO_MOJO_FEARS = TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "gojo_mojo_fears"));
    ...
    public static TagKey<AbstractSpell> ALIANA_SPELLS = create(ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "aliana_spells"));
    public static TagKey<AbstractSpell> ALSHANEX_SPELLS = create(ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "alshanex_spells"));
    ...
    public static TagKey<AbstractSpell> GOJO_MOJO_SPELLS = create(ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "gojo_mojo_spells"));
    ...
    public static TagKey<SchoolType> ALSHANEX_SCHOOLS= createSchoolTag(ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "alshanex_schools"));
    ...
    public static TagKey<SchoolType> GOJO_MOJO_SCHOOLS= createSchoolTag(ResourceLocation.fromNamespaceAndPath(MagicRealms.MODID, "gojo_mojo_schools"));
